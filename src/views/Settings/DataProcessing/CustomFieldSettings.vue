...
import { customSpanFieldsList } from '@/apis/server'
...
import EditingForm from './CustomFieldSettings/EditingForm.vue'
...
<template>
  <a-card style="margin-top: 10px">
    ...
    <a-modal v-model:open="openEditModal" title="自定义业务字段" @ok="save" destroyOnClose>
